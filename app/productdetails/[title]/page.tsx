...
//       `);
//     console.log(data)
//   const decodedId = decodeURIComponent(params.title); // 🛠️ Decode the URL param
//   console.log("Decoded Product ID:", decodedId);
//   const products = data.find((item) => item.title === params.title);
// console.log("data done=====> ", products)

//   return (
//     <div className="p-6">
//       <h1 className="text-2xl font-bold">Product Details</h1>
//       <h1 className="text-2xl font-bold">{products?.title}</h1>
//       <h1 className="text-2xl font-bold">{products?.price}</h1>
//       <h1 className="text-2xl font-bold">{products?.description}</h1>
//       <Image
...
//         />
//       <p className="mt-4">ID from URL: <strong>{decodedId}</strong></p>
//     </div>
//   );
// };
    ...
    <div className="p-6">
      ...
      {product.imageUrl && (
        <Image
          ...
          width={272}
          height={240}
          className="w-[272px] h-60 m-auto rounded-md my-4"
        />
      )}

      <p className="text-sm mt-4">
        ID from URL: <strong>{decodedTitle}</strong>
      </p>
    </div>
